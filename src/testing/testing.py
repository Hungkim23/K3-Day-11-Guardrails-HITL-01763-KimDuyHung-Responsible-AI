...
async def run_comparison():
    ...
    # --- Protected agent (TODO 9) ---
    print("\n" + "=" * 60)
    print("PHASE 2: Protected Agent (with Guardrail Plugins)")
    print("=" * 60)
    _init_judge()  # ensure judge runner is ready
...
class SecurityTestPipeline:
    ...
    async def run_all(self, attacks: list = None) -> list:
        ...
        # TODO 10: Run each attack and collect results
        results = []
